...
## Tasks
<!-- /orchestrate annotates these lines as it works: @base=<sha> for the commit a task
     started from, attempt=n/2 for the failure counter, and - [!] for a blocked task. -->
- [ ] T-001 — <title> (loop/tasks/T-001.md)

## Verification
<!-- /orchestrate walks these once every task is done, checking each off or noting
     why it could not be confirmed. Write scenarios someone can actually observe. -->
